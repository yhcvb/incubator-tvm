...
if(USE_OPENCL)
  include_directories(${CMAKE_SOURCE_DIR}/3rdparty/libopencl-stub/include)
  add_library(opencl STATIC ${CMAKE_SOURCE_DIR}/3rdparty/libopencl-stub/src/libopencl.c)
endif(USE_OPENCL)
...
if(USE_OPENCL)
  ...
  list(APPEND TVM_RUNTIME_LINKER_LIBS opencl)
